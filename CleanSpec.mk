...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/hwcomposer.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/hwcomposer.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/gralloc.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/gralloc.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/lights.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/lights.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/memtrack.kona.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/memtrack.kona.so)
